...
const RegionSelector = ({ onRegionChange, currentRegion }) => {
  ...
  const regions = [
    { value: 'central-coast', label: 'Central Coast', hostname: 'pokercentralcoast.com' },
    { value: 'newcastle', label: 'Newcastle', hostname: 'pokernewcastle.com' },
    { value: 'ballarat', label: 'Ballarat', hostname: 'pokerballarat.com' },
    { value: 'wollongong', label: 'Wollongong', hostname: 'pokerwollongong.com' },
    { value: 'townsville', label: 'Townsville', hostname: 'pokertownsville.com' },
    { value: 'sunshine-coast', label: 'Sunshine Coast', hostname: 'pokersunshinecoast.com' },
    { value: 'perth', label: 'Perth', hostname: 'pokerperth.com' },
    { value: 'geelong', label: 'Geelong', hostname: 'pokergeelong.com' },
    { value: 'gold-coast', label: 'Gold Coast', hostname: 'pokergoldcoast.com' }
  ];
