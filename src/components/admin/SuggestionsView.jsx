  ...
  return (
    <div className="mx-auto p-4 mt-8 max-w-screen-xl mb-8">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-white mb-2">Game Edit Suggestions</h1>
        <p className="text-gray-300">Review user suggestions for game updates</p>
      </div>
              ...
              <div className="card-body">
                ...
                <div className="mt-4 p-3 bg-slate-700 rounded-lg">
                  <div className="flex items-center space-x-2 text-sm text-gray-300">
                    <FiUser />
                    <span>Submitted by: {suggestion.submittedBy.displayName} ({suggestion.submittedBy.email})</span>
                  </div>
                </div>
